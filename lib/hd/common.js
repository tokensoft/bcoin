...
/**
 * Test whether the key is (most likely) a BIP44 account key or a BIP35.
 * BIP44 is a key at depth 2 that is hardened.
 * BIP35 is a key at depth 2 instead of 3 like BIP44 but is not hardened.
 * @param {HDPrivateKey|HDPublicKey} key
...
common.isAccount = function isAccount(key, account) {
  ...
  return ((key.depth === 3 && (key.childIndex & common.HARDENED) !== 0) || (key.depth === 2));
};
